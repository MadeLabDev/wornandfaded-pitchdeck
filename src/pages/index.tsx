					...
					<div className="overflow-scroll max-h-screen my-auto px-10 sm:px-15 lg:px-20 3xl:px-30 mx-auto w-full">
						<div className="py-2 xl:mt-20">
							<div className="3xl:my-20">
								...
								<div className="text-center leading-[1.2] font-bold text-3xl lg:text-4xl 3xl:text-5xl 6xl:text-6xl 11xl:text-7xl" data-swiper-parallax="-1000">
							...
							<div className="liner mt-[7vh] 3xl:mt-[10vh] 5xl:mt-[5vh] mb-20 text-center">
								<div className="liner__inner" data-swiper-parallax="300"></div>
								<div className="uppercase text-main-100 py-5 font-bold text-lg lg:text-xl 3xl:text-2xl 6xl:text-3xl 11xl:text-4xl" data-swiper-parallax="-300">Worn & Faded: The Untold History of the Band Tee • 1</div>
							</div>
						</div>
					</div>
				</SwiperSlide>
